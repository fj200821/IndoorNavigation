...
package com.capgemini.vuzixscanner.pedometer;
...
import com.capgemini.vuzixscanner.NavigationActivity;
...
public class StepService extends Service {
    ...
    public void reloadSettings() {
        ...
        if (mStepDetector != null) { 
            mStepDetector.setSensitivity(
                    Float.valueOf(mSettings.getString("sensitivity", "3"))
            );
        }
    ...
    private void showNotification() {
        ...
        Notification notification = new Notification(R.drawable.back_icon, null,
                System.currentTimeMillis());
        notification.flags = Notification.FLAG_NO_CLEAR | Notification.FLAG_ONGOING_EVENT;
        Intent pedometerIntent = new Intent();
        pedometerIntent.setComponent(new ComponentName(this, NavigationActivity.class));
        pedometerIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                pedometerIntent, 0);
       /* notification.setLatestEventInfo(this, text,
                "walking ", contentIntent);*/
